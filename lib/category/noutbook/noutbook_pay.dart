...
class NoutbooksPay extends StatefulWidget {
  Noutbooks noutbook;
  NoutbooksPay({Key? key, required this.noutbook}) : super(key: key);

  @override
  State<NoutbooksPay> createState() => _NoutbooksPayState();
}

class _NoutbooksPayState extends State<NoutbooksPay> {
