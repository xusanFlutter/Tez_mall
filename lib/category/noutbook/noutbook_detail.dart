...
import 'package:tez_mall/category/noutbook/noutbook_chat.dart';
import 'package:tez_mall/category/noutbook/noutbook_pay.dart';
import 'package:tez_mall/category/televizor/televizors.dart';
import 'package:tez_mall/provider/add_to_cart.dart';

class NoutbooksDetails extends StatefulWidget {
  Noutbooks noutbook;
  NoutbooksDetails({
    Key? key,
    required this.noutbook,
  }) : super(key: key);

  @override
  State<NoutbooksDetails> createState() => _NoutbooksDetailsState();
}

class _NoutbooksDetailsState extends State<NoutbooksDetails> {
  @override
              ...
              child: CupertinoButton(
                ...
                onPressed: () {
                  Navigator.push(
                    ...
                    CupertinoPageRoute(
                      builder: (context) =>
                          NoutbooksPay(noutbook: widget.noutbook),
                    ),
                  );
                },
              ),
                  ...
                  Navigator.push(
                    ...
                    CupertinoPageRoute(
                      builder: (context) => ChangeNotifierProvider.value(
                        value: counter,
                        child: NoutbooksChat(noutbook: widget.noutbook),
                      ),
                    ),
                  );
                },
              ...
              child: CupertinoButton(
                ...
                onPressed: () {
                  Provider.of<CounterModel>(context, listen: false).addCart(
                    Televizors(
                      name: widget.noutbook.name,
                      price: widget.noutbook.price,
                      description: widget.noutbook.description,
                      image: widget.noutbook.image,
                    ),
                  );
