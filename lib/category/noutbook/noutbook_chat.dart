...
class NoutbooksChat extends StatefulWidget {
  Noutbooks noutbook;

  NoutbooksChat({Key? key, required this.noutbook}) : super(key: key);

  @override
  State<NoutbooksChat> createState() => _NoutbooksChatState();
}

class _NoutbooksChatState extends State<NoutbooksChat> {
