...
class TelefonsChat extends StatefulWidget {
  Telefons telefons;

  TelefonsChat({Key? key, required this.telefons}) : super(key: key);

  @override
  State<TelefonsChat> createState() => _TelefonsChatState();
}

class _TelefonsChatState extends State<TelefonsChat> {
