...
class TelefonsPay extends StatefulWidget {
  Telefons telefons;
  TelefonsPay({Key? key, required this.telefons}) : super(key: key);

  @override
  State<TelefonsPay> createState() => _TelefonsPayState();
}

class _TelefonsPayState extends State<TelefonsPay> {
