...
import 'package:tez_mall/category/maishiy/maishiy_chat.dart';

// ignore: must_be_immutable
class MaishiysPay extends StatefulWidget {
  Maishiys maishiy;
  MaishiysPay({Key? key, required this.maishiy}) : super(key: key);

  @override
  State<MaishiysPay> createState() => _MaishiysPayState();
}

class _MaishiysPayState extends State<MaishiysPay> {
