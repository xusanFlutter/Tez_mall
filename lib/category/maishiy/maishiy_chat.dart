...
class MaishiysChat extends StatefulWidget {
  Maishiys maishiy;

  MaishiysChat({Key? key, required this.maishiy}) : super(key: key);

  @override
  State<MaishiysChat> createState() => _MaishiysChatState();
}

class _MaishiysChatState extends State<MaishiysChat> {
