...
class TelevizorPay extends StatefulWidget {
  Televizors televizors;
  TelevizorPay({Key? key, required this.televizors}) : super(key: key);

  @override
  State<TelevizorPay> createState() => _TelevizorPayState();
}

class _TelevizorPayState extends State<TelevizorPay> {
